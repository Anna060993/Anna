...
acf(y2)
pacf(y2)
# La distribuzione marginale del processo è simmetrica e leptocurtica. 
...
# Significa che è stata colta la relazione di dipendenza osservata sui quadrati dei rendimenti. 

# Verifica dell'assunto di normalità.
...
JB
# Il valore della statistica test JB va confrontato con i quantili di una Chi-quadro con 2 gradi di libertà.
# Calcolo del p-value:
pchisq(JB,df=2,lower.tail=F) 
# L'ipotesi nulla H0 viene accettata: i residui standardizzati seguono una distribuzione normale.

# Oppure si può usare la libreria tseries: 
# library(tseries)
